...
const Preferences = () => {
  const [notificationSettings, setNotificationSettings] = useState("All"); // Default option for select
  const [notificationFrequency, setNotificationFrequency] = useState(50); // Default value for range slider
  const [isChecked, setIsChecked] = useState(false); // Default value for checkbox
  const [notification, setNotification] = useState(''); // State for the success message

  // Function to handle saving preferences and show success notification
  const handleSave = () => {
    setNotification('Preferences have been saved!'); // Show success notification
      ...
      <div className="w-[400px]">
        ...
        <div className="flex justify-center">
          <button
            ...
            onClick={handleSave} // Save function on click
          >
            Save preferences
          </button>
        </div>
